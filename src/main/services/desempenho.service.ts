...
const METADADOS_PERMITIDOS = new Set(['placeholders', 'previasCriadas', 'previasRemovidas', 'tabelas', 'linhas', 'celulas', 'tabelasPersonalizadas', 'incremental', 'tentativas', 'imagens', 'imagensMemoria', 'itensRenderizados', 'bytesEntrada', 'bytesSaida', 'arquivosRelidos', 'sucesso', 'falhou', 'quantidade', 'tabelaB602', 'fallback']);
