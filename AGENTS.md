...
- **PRs por feature**: mantenha o menor número de PRs compatível com uma revisão segura. Concentre ajustes relacionados, correções de CI e complementos da mesma feature no PR aberto ou em sua branch principal; abra outro PR somente quando o isolamento trouxer benefício claro de segurança, reversão, revisão ou entrega independente. Justifique a exceção na descrição do novo PR.
