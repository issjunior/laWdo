...
`construirMapaPlaceholdersResolvidos()` descreve cada chave com valor, `preenchido` e formato `texto`/`html`. O mapa evita que cada consumidor implemente seu próprio critério de ausência ou HTML estrutural.
